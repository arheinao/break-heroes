...
import TermsContentDE from "./content/de";
...
export default async function TermsPage({
  ...
  const Content = CONTENT[locale as keyof typeof CONTENT] ?? TermsContentEN;
